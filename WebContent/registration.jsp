...
<body>
    ...
    <div class="container" style="width:50%; border: 1px solid rgb(243, 245, 245); border-radius:2%; margin-bottom: 2%;">
        <h1>Register</h1>
        <form action="http://localhost:8080/MedXplore/register" method="POST">
            <div class="form-group">
                <label for="exampleRoleName">Role: </label>
                <input type="text" readonly class="form-control" id="exampleRoleName" name="roleName" value="User" required>
            </div>
            <div class="form-group">
