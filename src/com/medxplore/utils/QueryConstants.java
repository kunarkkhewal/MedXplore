...
public interface QueryConstants {
	...
	String MAIN_MED_SQL = "SELECT M.MEDNAME, M.PACKSIZE, M.PRICE, M.SALT, S.SNAME, S.SADDRESS, S.SCONTACTNO FROM MED_MST M, STORE_MST S, MED_STORE_MAPPING MS WHERE M.MEDID=MS.MEDID AND S.SID=MS.SID AND M.MEDNAME=?";
	
	//String ALT_MED_LIST_SQL = "SELECT M.MEDNAME, M.PRICE, M.SALT FROM MED_MST M WHERE M.SALT=?";
